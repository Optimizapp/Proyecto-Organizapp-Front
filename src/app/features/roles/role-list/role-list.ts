  ...
  template: `
    <div class="stub-page">
      <div class="stub-header">
        ...
        <div>
          <h2 class="stub-title">Roles</h2>
          <p class="stub-subtitle">Administración de roles y permisos por empresa o proceso</p>
        </div>
      ...
      <div class="stub-coming-soon">
        ...
        <p>La gestión de roles estará disponible próximamente.<br>Define permisos granulares para cada usuario.</p>
        <div class="coming-chips">
          <span class="chip">Crear roles</span>
          <span class="chip">Asignación de permisos</span>
          <span class="chip">Roles por proceso</span>
        </div>
      </div>
    </div>
  `,
