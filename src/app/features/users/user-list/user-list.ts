  ...
  template: `
    <div class="stub-page">
      <div class="stub-header">
        ...
        <div>
          <h2 class="stub-title">Usuarios</h2>
          <p class="stub-subtitle">Crear y consultar usuarios por empresa y rol</p>
        </div>
      ...
      <div class="stub-coming-soon">
        ...
        <p>La gestión de usuarios estará disponible próximamente.<br>Administra quién tiene acceso a cada proceso.</p>
        <div class="coming-chips">
          <span class="chip">Crear usuarios</span>
          <span class="chip">Asignación de roles</span>
          <span class="chip">Perfiles por empresa</span>
        </div>
      </div>
    </div>
  `,
